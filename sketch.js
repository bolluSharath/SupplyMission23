...
function setup() {
	...
	box1Sprite = createSprite(280,620,20,100);
	box2Sprite = createSprite(500,620,20,100);
	box3Sprite = createSprite(390,660,200,20);
	...
	ground = Bodies.rectangle(width/2, 650, width, 10 , {isStatic:false} );
	 ...
	 box3 = Bodies.rectangle(width/2,645,width,10,{isStatic:true});
